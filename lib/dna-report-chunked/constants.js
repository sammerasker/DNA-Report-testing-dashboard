...
export const API_PROVIDERS = {
  CEREBRAS: {
    name: 'Cerebras',
    endpoint: process.env.NEXT_PUBLIC_CEREBRAS_ENDPOINT || 'https://api.cerebras.ai/v1/chat/completions',
    apiKey: process.env.NEXT_PUBLIC_CEREBRAS_API_KEY || 'csk-3dcf55tf66fm5rtv5h2kcvnxhj9xrx3pj6wm9tnk5cn85eypwe',
    defaultModel: process.env.NEXT_PUBLIC_CEREBRAS_MODEL || 'gpt-oss-120b'
  },
  OPENROUTER: {
    name: 'OpenRouter',
    endpoint: process.env.NEXT_PUBLIC_OPENROUTER_ENDPOINT || 'https://openrouter.ai/api/v1/chat/completions',
    apiKey: process.env.NEXT_PUBLIC_OPENROUTER_API_KEY || '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',
    defaultModel: process.env.NEXT_PUBLIC_OPENROUTER_MODEL || 'openrouter/free'
  }
};
